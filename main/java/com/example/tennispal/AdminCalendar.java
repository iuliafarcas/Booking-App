...
public class AdminCalendar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        calender = (CalendarView)findViewById(R.id.acalender);
        date_view = (TextView)findViewById(R.id.adate_view);
        ...
        h8 = (TextView)findViewById(R.id.ah15);
        h9 = (TextView)findViewById(R.id.ah9);

        cb8 = findViewById(R.id.acb8);
        cb9 = findViewById(R.id.acb9);
        cb10 = findViewById(R.id.acb10);
        cb11 = findViewById(R.id.acb11);
        cb12 = findViewById(R.id.acb12);
        cb13 = findViewById(R.id.acb13);
        cb14 = findViewById(R.id.acb14);
        cb15 = findViewById(R.id.acb15);
        cb16 = findViewById(R.id.acb16);
        cb17 = findViewById(R.id.acb17);
        cb18 = findViewById(R.id.acb18);
        cb19 = findViewById(R.id.acb19);
        cb20 = findViewById(R.id.acb20);
        cb21 = findViewById(R.id.acb21);


        book = findViewById(R.id.abbook);
        ...
        book.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(date.equals(""))
                    Toast.makeText(AdminCalendar.this,"SELECT A DAY!", Toast.LENGTH_SHORT).show();
                else book();


                if(!b8 || !b9 || !b10 || !b11 || !b12 || !b13 || !b14 || !b15 || !b16 || !b17 || !b18 || !b19 || !b20 || !b21)
                    Toast.makeText(AdminCalendar.this,"Booking successful", Toast.LENGTH_SHORT).show();
                else Toast.makeText(AdminCalendar.this,"Please select an hour.", Toast.LENGTH_SHORT).show();
